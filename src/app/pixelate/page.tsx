            ...
            <Card className="rounded-3xl border-none shadow-xl overflow-hidden">
              ...
              <CardContent className="p-6 space-y-8">
                <div className="space-y-4">
                  <Label className="text-[10px] uppercase font-bold text-muted-foreground">Level: {101 - pixelSize[0]}</Label>
                  <Slider value={pixelSize} onValueChange={setPixelSize} min={1} max={50} step={1} inverted />
                </div>
