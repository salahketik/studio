  ...
  return (
    <div className="min-h-full hero-gradient pb-20 overflow-x-hidden">
      <div className="container mx-auto px-4 sm:px-6 md:p-16 lg:p-24 space-y-16 sm:space-y-24">
        ...
        {/* Tools by Category */}
        <div id="tools" className="space-y-16 sm:space-y-20">
          {categories.map((category) => (
            <div key={category.name} className="space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="glass-panel rounded-3xl p-6 sm:p-8 md:p-12 grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 text-center md:text-left border-none shadow-2xl">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-4 sm:gap-6">
                ...
                <div className="space-y-1 sm:space-y-2">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">Alat yang dikelompokkan berdasarkan kebutuhan alur kerja Anda.</p>
                </div>
            </div>
            <div className="flex flex-col md:flex-row items-center md:items-start gap-4 sm:gap-6">
                ...
                <div className="space-y-1 sm:space-y-2">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">Pemrosesan lokal di browser Anda untuk keamanan data maksimal.</p>
                </div>
            </div>
            <div className="flex flex-col md:flex-row items-center md:items-start gap-4 sm:gap-6">
                ...
                <div className="space-y-1 sm:space-y-2">
                    <h4 className="text-lg sm:text-xl font-bold">Akses Instan</h4>
